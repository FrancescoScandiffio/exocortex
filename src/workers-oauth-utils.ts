...
export function renderApprovalDialog(request: Request, options: ApprovalDialogOptions): Response {
  ...
  `;
    ...
    return new Response(htmlContent, {
        headers: {
            "Content-Security-Policy": "default-src 'none'; style-src 'unsafe-inline'; script-src 'self'; img-src 'self' https:; base-uri 'self'; connect-src 'self'; frame-ancestors 'none'",
